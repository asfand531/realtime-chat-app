export const speedDialActions = [
  {
    ...
    accept: "image/*, video/*",
    capture: "environment",
    onClick: () => console.log(`${speedDialActions[0].label} clicked!`),
  },
  {
    label: "Documents",
    id: "documentInput",
    ...
    onClick: () => console.log(`${speedDialActions[1].label} clicked!`),
  },
  {
    label: "Images",
    id: "imageInput",
    ...
    onClick: () => {
      ...
      console.log(`${speedDialActions[2].label} clicked!`);
    },
  },
  {
    label: "Voice",
    ...
    accept: "audio/*",
    onClick: () => console.log(`${speedDialActions[3].label} clicked!`),
  },
];
